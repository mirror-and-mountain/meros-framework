...
trait HasDataFields {
     ...
     * 
     * @return DataField The created DataField instance.
     */
     ...
     *
     * @return DataField The resolved Field instance.
     */
    public function resolveFieldType(string $type, array $config = []): DataField {
     ...
     * @return void
     */
    protected function applyAutoFields(DataFieldRegistrar $registrar, array $map = []): void {
