...
class Registry {
     ...
     * @param  FeatureBuilder|FieldRenderer $item The item to add.
     * 
     * @return FeatureBuilder|FieldRenderer|null       The item that was added or retrieved if it already exists in the collection
     * @throws \InvalidArgumentException if the specified type does not correspond to a valid collection in the registry.
     */
    public function add(string $type, FeatureBuilder|FieldRenderer $item): FeatureBuilder|FieldRenderer {
