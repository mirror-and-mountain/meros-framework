...
if [ $SOURCE_ENV = 'local_dev' ]; then
    ...
    rsync -avz \
        ...
        "${DEST_SSH_HOST}:${DEST_PATH}/wp-content/themes/${THEME_SLUG}/" \
            ...
            --exclude='/vendor/mirror-and-mountain/meros-framework/.git/' \
            --exclude='/vendor/mirror-and-mountain/meros-framework/.gitattributes' \
            --exclude='/vendor/mirror-and-mountain/meros-framework/.gitignore' \
            --exclude='/vendor/mirror-and-mountain/meros-framework/package.json' \
            --exclude='/vendor/mirror-and-mountain/meros-framework/package-lock.json' \
            --exclude='/vendor/mirror-and-mountain/meros-framework/node_modules/' \
            --exclude='/vendor/mirror-and-mountain/meros-framework/webpack.assets.config.js' \
