...
interface Registrable extends FeatureDefinition {
    /**
     * Creates a new instance of the feature definition from a registered feature.
     *
     ...
     */
    public static function __make_from_registered(
