@include('meros::toolbox.form-builder.canvas.sidebar')
...
@include('meros::toolbox.form-builder.canvas.repeater-builder')
@include('meros::toolbox.form-builder.canvas.field-settings')