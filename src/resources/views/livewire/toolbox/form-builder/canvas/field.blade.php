@if(($scope ?? 'top') === 'group')
    ...
    >
        <div
            ...
            @drop.prevent="$store.formDrag.hideInsertMarker($el); $store.formDrag.itemKind !== 'field' ? null : ($store.formDrag.sourceGroupRowIndex === {{ $groupRowIndex }} ? $wire.relocateFieldInGroup({{ $groupRowIndex }}, $store.formDrag.sourceGroupInnerRowIndex, $store.formDrag.sourceFieldIndex, {{ $groupRowInnerIndex }}, {{ $groupFieldIndex }}) : ($store.formDrag.sourceGroupRowIndex !== null ? $wire.moveFieldBetweenGroups($store.formDrag.sourceGroupRowIndex, $store.formDrag.sourceGroupInnerRowIndex, $store.formDrag.sourceFieldIndex, {{ $groupRowIndex }}, {{ $groupRowInnerIndex }}, {{ $groupFieldIndex }}) : ($store.formDrag.isCanvasDrag ? $wire.moveFieldToGroupRow($store.formDrag.sourceRowIndex, $store.formDrag.sourceFieldIndex, {{ $groupRowIndex }}, {{ $groupRowInnerIndex }}, {{ $groupFieldIndex }}) : $wire.insertFieldIntoGroupRow({{ $groupRowIndex }}, {{ $groupRowInnerIndex }}, {{ $groupFieldIndex }}, $store.formDrag.itemHandle))))"
        >
        ...
        <div
            ...
            @dragover.prevent="$store.formDrag.showInsertMarker($el)"
            @dragleave="$store.formDrag.hideInsertMarker($el)"
            @drop.prevent="$store.formDrag.hideInsertMarker($el); $store.formDrag.itemKind !== 'field' ? null : ($store.formDrag.sourceGroupRowIndex === {{ $groupRowIndex }} ? $wire.relocateFieldInGroup({{ $groupRowIndex }}, $store.formDrag.sourceGroupInnerRowIndex, $store.formDrag.sourceFieldIndex, {{ $groupRowInnerIndex }}, {{ $groupFieldIndex + 1 }}) : ($store.formDrag.sourceGroupRowIndex !== null ? $wire.moveFieldBetweenGroups($store.formDrag.sourceGroupRowIndex, $store.formDrag.sourceGroupInnerRowIndex, $store.formDrag.sourceFieldIndex, {{ $groupRowIndex }}, {{ $groupRowInnerIndex }}, {{ $groupFieldIndex + 1 }}) : ($store.formDrag.isCanvasDrag ? $wire.moveFieldToGroupRow($store.formDrag.sourceRowIndex, $store.formDrag.sourceFieldIndex, {{ $groupRowIndex }}, {{ $groupRowInnerIndex }}, {{ $groupFieldIndex + 1 }}) : $wire.insertFieldIntoGroupRow({{ $groupRowIndex }}, {{ $groupRowInnerIndex }}, {{ $groupFieldIndex + 1 }}, $store.formDrag.itemHandle))))"
        >
...
@else
    ...
    >
        <div
            ...
            @dragover.prevent="$store.formDrag.showInsertMarker($el)"
            @dragleave="$store.formDrag.hideInsertMarker($el)"
            @drop.prevent="$store.formDrag.hideInsertMarker($el); $store.formDrag.itemKind !== 'field' ? null : ($store.formDrag.sourceGroupRowIndex !== null ? $wire.moveFieldFromGroupToRow($store.formDrag.sourceGroupRowIndex, $store.formDrag.sourceGroupInnerRowIndex, $store.formDrag.sourceFieldIndex, {{ $fieldRowIndex }}, {{ $fieldIndex }}) : ($store.formDrag.isCanvasDrag ? $wire.relocateField($store.formDrag.sourceRowIndex, $store.formDrag.sourceFieldIndex, {{ $fieldRowIndex }}, {{ $fieldIndex }}) : $wire.insertFieldIntoRow({{ $fieldRowIndex }}, {{ $fieldIndex }}, $store.formDrag.fieldType)))"
        >
            <div class="ml-2 w-0.5 h-3/4 bg-blue-400 rounded-md" style="opacity:0;transition:opacity 0.15s, height 0.15s, box-shadow 0.15s"></div>
        </div>
        ...
        <div
            ...
            @dragover.prevent="$store.formDrag.showInsertMarker($el)"
            @dragleave="$store.formDrag.hideInsertMarker($el)"
            @drop.prevent="$store.formDrag.hideInsertMarker($el); $store.formDrag.itemKind !== 'field' ? null : ($store.formDrag.sourceGroupRowIndex !== null ? $wire.moveFieldFromGroupToRow($store.formDrag.sourceGroupRowIndex, $store.formDrag.sourceGroupInnerRowIndex, $store.formDrag.sourceFieldIndex, {{ $fieldRowIndex }}, {{ $fieldIndex + 1 }}) : ($store.formDrag.isCanvasDrag ? $wire.relocateField($store.formDrag.sourceRowIndex, $store.formDrag.sourceFieldIndex, {{ $fieldRowIndex }}, {{ $fieldIndex + 1 }}) : $wire.insertFieldIntoRow({{ $fieldRowIndex }}, {{ $fieldIndex + 1 }}, $store.formDrag.fieldType)))"
        >
