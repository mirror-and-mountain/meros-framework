...
class MigrationCommands {
     ...
     * wp meros:migration run my_feature staging --user=admin
     * wp meros:migration run my_feature staging --refresh --user=admin
     *
     * @subcommand run
     *
     * @when after_wp_load
     ...
     * wp meros:migration rollback my_feature staging --user=admin
     *
     * @subcommand rollback
     *
     * @when after_wp_load
     ...
     * ## EXAMPLES
     *
     * wp meros:migration setup staging --user=admin
     * wp meros:migration setup staging --refresh --user=admin
     *
     * @subcommand setup
     *
     * @when after_wp_load
